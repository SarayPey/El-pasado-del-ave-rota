...
## Pantalla de menú ############################################################
##
## Esta pantalla presenta las opciones internas al juego de la sentencia
...
## Espaciado entre botones  
        imagebutton:  
            idle  "Extra/GUI/Jugar.png"  
            hover "Extra/GUI/JugarHover.png"  
            action Start()  
            # hover_sound "audio/Infancia.mp3"

        imagebutton:  
            idle  "Extra/GUI/Cargar.png"  
            hover "Extra/GUI/CargarHover.png"  
            action ShowMenu("load")  
            # hover_sound "audio/Academia9.mp3"

        imagebutton:  
            idle  "Extra/GUI/Opciones.png"  
            hover "Extra/GUI/OpcionesHover.png"  
            action ShowMenu("preferences")  
            # hover_sound "audio/Aviones.mp3"

        imagebutton:  
            idle  "Extra/GUI/AcercaDe.png"  
            hover "Extra/GUI/AcercaDeHover.png"  
            action ShowMenu("about")  
            # hover_sound "audio/Fragilidad.mp3"

        # imagebutton:  
        #     idle  "Extra/GUI/Galeria.png"  
        #     hover "Extra/GUI/GaleriaHover.png"  
        #     action ShowMenu("album")
        #     # hover_sound "audio/Vacio.mp3"  

        # imagebutton:  
        #     idle  "Extra/GUI/Tienda.png"  
        #     hover "Extra/GUI/TiendaHover.png"  
        #     action ShowMenu("store")
        #     # hover_sound "audio/Desesperacion.mp3"

        imagebutton:  
            idle  "Extra/GUI/Ayuda.png"  
            hover "Extra/GUI/AyudaHover.png"  
            action ShowMenu("help")
            # hover_sound "audio/Anhelo.mp3"  

        imagebutton:  
            idle  "Extra/GUI/Salir.png"  
            hover "Extra/GUI/SalirHover.png"  
            action Quit()
            # hover_sound "audio/Mascara.mp3"

    add "images/Extra/GUI/Titulo2.png" xalign 1.2 yalign 1.4
    # if gui.show_name:
