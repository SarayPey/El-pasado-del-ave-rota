...
define config.name = _("El pasado del ave rota")
...
Programación: SarayPey

Código realizado con Renpy y Python.
...
define build.name = "Elpasadodelaverota"
...
define config.main_menu_music = "003.ChefDetectiveMantra.mp3"
...
define config.save_directory = "Elpasadodelaveherida-1766873730"
